...
const { addWorkCompleted, addWorkNotCompleted, alertIsPresent, alertIsNotPresent } = require('../utils/utils_e2e');

// const addWorkCompleted = (browser, newData) => {
...
// const addWorkNotCompleted = (browser, newData) => {
...
// const alertIsNotPresent = (browser) => {
//     browser
//     .pause(5000)
//     .ensure.not.alertIsPresent()
// }
...
module.exports = {
    // AppNotification24Hours71_59: (browser) => {
    ...
    //     let endDt = new Date(dt.getTime()+hours72Millis-oneMinuteMillis);
    ...
    AppNotification24Hours72_01: (browser) => {
        // const addBtn2 = browser.element.find('.add-btn2[type="submit"]');
        // const addForm = browser.element.find('.add-work');
        ...
        // within 4 hours of start - 3 hours
        let endDt = new Date(dt.getTime()+hours72Millis+oneMinuteMillis+oneMinuteMillis);
    ...
    // AppNotification24Hours68_01: (browser) => {
    //     // const addBtn2 = browser.element.find('.add-btn2[type="submit"]');
    //     // const addForm = browser.element.find('.add-work');
    ...
    //     // within 4 hours of start - 3 hours
    //     let endDt = new Date(dt.getTime()+hours72Millis-(4*oneHourMillis)+(2*oneMinuteMillis));
    ...
    // AppNotification24Hours67_59: (browser) => {
    //     // const addBtn2 = browser.element.find('.add-btn2[type="submit"]');
    //     // const addForm = browser.element.find('.add-work');
