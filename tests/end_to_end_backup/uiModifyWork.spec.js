...
module.exports = {
    // AppMainPageElementsTest: function(browser) {
    //     browser
    //         .url('http://127.0.0.1:5500')
    //         .waitForElementVisible('.nav-wrapper')
    //         .pause(3000)
    ...
    //         .assert.textContains('.nav-wrapper', 'Work Notification System')
    //         .pause(3000)


    //     browser.assert.titleEquals('Work Notification System')
    //     // browser.end();
        
    // },

    // AppSideMenuTest: (browser) => {
    //     // const sidenav = browser.element.find('.side-menu').waitUntil('visible');
    ...
    //         .pause(1000)
    //         .click(rightMenu)
    //         .assert.textContains('#side-menu1', 'Work Notification System')
    //         .assert.textContains('#side-menu1', 'Home')
    //         .assert.textContains('#side-menu1', 'About')
    //         // .saveScreenshot('tests_output/AppSideMenuTest')
    //         // .end();
    // },

    // AppSideMenuTestAbout: (browser) => {
    //     const rightMenu = '.right-menu';
    //     const about = 'a[href="/pages/about.html"]';

    //     browser
    //         // .url('http://127.0.0.1:5500')
    //         // .pause(500)
    //         .click(about)
    //         .assert.textContains('.info', 'Manage all the works and notifications in one place.')
    //         // .saveScreenshot('tests_output/AppSideMenuTestAbout.png')
    //         // .end();
    // },

    // AppSideMenuTestContact: (browser) => {
    //     const rightMenu = '.right-menu';
    //     const contact = 'a[href="/pages/contact.html"]';
    ...
    //         // .pause(3000)
    //         .click(contact)
    //         .assert.textContains('.info', 'Contact Us at abc@def.com')
    //         .saveScreenshot('tests_output/AppSideMenuTestContact.png')
    //         // .end();
    // },
